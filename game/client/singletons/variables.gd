...
var _reset_player_position := Vector2(0, 0)
...
# this is for the high_score scene. the first index is the player position at the high score table, followed by the name of the player, the score the player had and how many move turns made in that game.
...
@onready var _puzzle_room_block_values := [
...
var select_json_dictionary_singly := false
...
var select_items_data_to_return := 0
