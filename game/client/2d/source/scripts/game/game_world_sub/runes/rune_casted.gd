...
func hit_points_recovered_text(_hp_calc):
	...
	var _hp_max_calc = int( PC._hp_max - PC._hp )
...
func cast_at_object_self():
	...
	PC._mp -= Json._magic[Variables._rune_current_selected_name]["MP"]
		
	match (Variables._rune_current_selected_name):
		"minor_healing":
			var _hp_calc :float = 0.2 * PC._hp_max
			hit_points_recovered_text(_hp_calc)
			
		"light_healing":
			var _hp_calc :float = 0.4 * PC._hp_max
			hit_points_recovered_text(_hp_calc)
			
		"intense_healing":
			var _hp_calc :float = 0.6 * PC._hp_max
			hit_points_recovered_text(_hp_calc)
		
		"ultimate_healing":	
			var _hp_calc :float = 0.8 * PC._hp_max
			hit_points_recovered_text(_hp_calc)
		
		"restoration":	
			var _hp_calc :float = 1.0 * PC._hp_max
			hit_points_recovered_text(_hp_calc)
