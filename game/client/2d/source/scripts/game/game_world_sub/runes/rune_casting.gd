...
func rune_position_show():
	...
	if Settings._system.automatic_rune_casting and Variables._rune_currently_selected != -1:	
...
func set_rune_guides():
	...
	if game.map[x][y-1] != Enum.Tile.Floor and game.map[x][y-1] != Enum.Tile.Floor_rooms:
		_rune_guide_sprite[5][4].visible = false
		_rune_guide_value[5][4] = 0 
	
		_break_at_north = true
		
	if game.map[x][y-2] != Enum.Tile.Floor and game.map[x][y-2] != Enum.Tile.Floor_rooms or _break_at_north == true:
		_rune_guide_sprite[5][3].visible = false
		_rune_guide_value[5][3] = 0
	
		_break_at_north = true

	if game.map[x][y-3] != Enum.Tile.Floor and game.map[x][y-3] != Enum.Tile.Floor_rooms or _break_at_north == true:
		_rune_guide_sprite[5][2].visible = false
		_rune_guide_value[5][2] = 0
	
		_break_at_north = true

	if game.map[x][y-4] != Enum.Tile.Floor and game.map[x][y-4] != Enum.Tile.Floor_rooms or _break_at_north == true:
		_rune_guide_sprite[5][1].visible = false
		_rune_guide_value[5][1] = 0
	
		_break_at_north = true
		
	if game.map[x][y-5] != Enum.Tile.Floor and game.map[x][y-5] != Enum.Tile.Floor_rooms or _break_at_north == true:
	...
	if game.map[x+1][y-1] != Enum.Tile.Floor and game.map[x+1][y-1] != Enum.Tile.Floor_rooms:
		_rune_guide_sprite[6][4].visible = false
		_rune_guide_value[6][4] = 0
	
		_break_at_north_east = true
		
	if game.map[x+2][y-2] != Enum.Tile.Floor and game.map[x+2][y-2] != Enum.Tile.Floor_rooms or _break_at_north_east == true:
		_rune_guide_sprite[7][3].visible = false
		_rune_guide_value[7][3] = 0
	
		_break_at_north_east = true
	
	if game.map[x+3][y-3] != Enum.Tile.Floor and game.map[x+3][y-3] != Enum.Tile.Floor_rooms or _break_at_north_east == true:
		_rune_guide_sprite[8][2].visible = false
		_rune_guide_value[8][2] = 0
	
		_break_at_north_east = true

	if game.map[x+4][y-4] != Enum.Tile.Floor and game.map[x+4][y-4] != Enum.Tile.Floor_rooms or _break_at_north_east == true:
		_rune_guide_sprite[9][1].visible = false
		_rune_guide_value[9][1] = 0
	
		_break_at_north_east = true
			
	if game.map[x+5][y-5] != Enum.Tile.Floor and game.map[x+5][y-5] != Enum.Tile.Floor_rooms or _break_at_north_east == true:
	...
	if game.map[x+1][y] != Enum.Tile.Floor and game.map[x+1][y] != Enum.Tile.Floor_rooms:
		_rune_guide_sprite[6][5].visible = false
		_rune_guide_value[6][5] = 0 
	
		_break_at_east = true
		
	if game.map[x+2][y] != Enum.Tile.Floor and game.map[x+2][y] != Enum.Tile.Floor_rooms or _break_at_east == true:
		_rune_guide_sprite[7][5].visible = false
		_rune_guide_value[7][5] = 0
	
		_break_at_east = true

	if game.map[x+3][y] != Enum.Tile.Floor and game.map[x+3][y] != Enum.Tile.Floor_rooms or _break_at_east == true:
		_rune_guide_sprite[8][5].visible = false
		_rune_guide_value[8][5] = 0
	
		_break_at_east = true

	if game.map[x+4][y] != Enum.Tile.Floor and game.map[x+4][y] != Enum.Tile.Floor_rooms or _break_at_east == true:
		_rune_guide_sprite[9][5].visible = false
		_rune_guide_value[9][5] = 0
	
		_break_at_east = true
			
	if game.map[x+5][y] != Enum.Tile.Floor and game.map[x+5][y] != Enum.Tile.Floor_rooms or _break_at_east == true:
	...
	if game.map[x+2][y+2] != Enum.Tile.Floor and game.map[x+2][y+2] != Enum.Tile.Floor_rooms or _break_at_south_east == true:
		_rune_guide_sprite[7][7].visible = false
		_rune_guide_value[7][7] = 0
	
		_break_at_south_east = true

	if game.map[x+3][y+3] != Enum.Tile.Floor and game.map[x+3][y+3] != Enum.Tile.Floor_rooms or _break_at_south_east == true:
		_rune_guide_sprite[8][8].visible = false
		_rune_guide_value[8][8] = 0
	
		_break_at_south_east = true

	if game.map[x+4][y+4] != Enum.Tile.Floor and game.map[x+4][y+4] != Enum.Tile.Floor_rooms or _break_at_south_east == true:
		_rune_guide_sprite[9][9].visible = false
		_rune_guide_value[9][9] = 0
	
		_break_at_south_east = true
			
	if game.map[x+5][y+5] != Enum.Tile.Floor and game.map[x+5][y+5] != Enum.Tile.Floor_rooms or _break_at_south_east == true:
	...
	if game.map[x][y+2] != Enum.Tile.Floor and game.map[x][y+2] != Enum.Tile.Floor_rooms or _break_at_south == true:
		_rune_guide_sprite[5][7].visible = false
		_rune_guide_value[5][7] = 0
	
		_break_at_south = true

	if game.map[x][y+3] != Enum.Tile.Floor and game.map[x][y+3] != Enum.Tile.Floor_rooms or _break_at_south == true:
		_rune_guide_sprite[5][8].visible = false
		_rune_guide_value[5][8] = 0
	
		_break_at_south = true

	if game.map[x][y+4] != Enum.Tile.Floor and game.map[x][y+4] != Enum.Tile.Floor_rooms or _break_at_south == true:
		_rune_guide_sprite[5][9].visible = false
		_rune_guide_value[5][9] = 0
	
		_break_at_south = true
			
	if game.map[x][y+5] != Enum.Tile.Floor and game.map[x][y+5] != Enum.Tile.Floor_rooms or _break_at_south == true:
	...
	if game.map[x-2][y+2] != Enum.Tile.Floor and game.map[x-2][y+2] != Enum.Tile.Floor_rooms or _break_at_south_west == true:
		_rune_guide_sprite[3][7].visible = false
		_rune_guide_value[3][7] = 0
	
		_break_at_south_west = true
	
	if game.map[x-3][y+3] != Enum.Tile.Floor and game.map[x-3][y+3] != Enum.Tile.Floor_rooms or _break_at_south_west == true:
		_rune_guide_sprite[2][8].visible = false
		_rune_guide_value[2][8] = 0
	
		_break_at_south_west = true

	if game.map[x-4][y+4] != Enum.Tile.Floor and game.map[x-4][y+4] != Enum.Tile.Floor_rooms or _break_at_south_west == true:
		_rune_guide_sprite[1][9].visible = false
		_rune_guide_value[1][9] = 0
	
		_break_at_south_west = true
			
	if game.map[x-5][y+5] != Enum.Tile.Floor and game.map[x-5][y+5] != Enum.Tile.Floor_rooms or _break_at_south_west == true:
	...
	if game.map[x-2][y] != Enum.Tile.Floor and game.map[x-2][y] != Enum.Tile.Floor_rooms or _break_at_west == true:
		_rune_guide_sprite[3][5].visible = false
		_rune_guide_value[3][5] = 0
	
		_break_at_west = true
	
	if game.map[x-3][y] != Enum.Tile.Floor and game.map[x-3][y] != Enum.Tile.Floor_rooms or _break_at_west == true:
		_rune_guide_sprite[2][5].visible = false
		_rune_guide_value[2][5] = 0
	
		_break_at_west = true

	if game.map[x-4][y] != Enum.Tile.Floor and game.map[x-4][y] != Enum.Tile.Floor_rooms or _break_at_west == true:
		_rune_guide_sprite[1][5].visible = false
		_rune_guide_value[1][5] = 0
	
		_break_at_west = true
			
	if game.map[x-5][y] != Enum.Tile.Floor and game.map[x-5][y] != Enum.Tile.Floor_rooms or _break_at_west == true:
	...
	if game.map[x-2][y-2] != Enum.Tile.Floor and game.map[x-2][y-2] != Enum.Tile.Floor_rooms or _break_at_north_west == true:
		_rune_guide_sprite[3][3].visible = false
		_rune_guide_value[3][3] = 0
	
		_break_at_north_west = true
	
	if game.map[x-3][y-3] != Enum.Tile.Floor and game.map[x-3][y-3] != Enum.Tile.Floor_rooms or _break_at_north_west == true:
		_rune_guide_sprite[2][2].visible = false
		_rune_guide_value[2][2] = 0
	
		_break_at_north_west = true

	if game.map[x-4][y-4] != Enum.Tile.Floor and game.map[x-4][y-4] != Enum.Tile.Floor_rooms or _break_at_north_west == true:
		_rune_guide_sprite[1][1].visible = false
		_rune_guide_value[1][1] = 0
		
		_break_at_north_west = true
		
	if game.map[x-5][y-5] != Enum.Tile.Floor and game.map[x-5][y-5] != Enum.Tile.Floor_rooms or _break_at_north_west == true:
